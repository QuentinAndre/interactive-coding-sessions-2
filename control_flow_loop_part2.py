...
for key in my_info:
    value = my_info[key]
    print(f"The current key is {key}, and its associated value is {value}.")
...
first_fruit, second_fruit, third_fruit = my_fruits
...
# Whenever you face that, you have great tool: enumerate()
# How does it work:
