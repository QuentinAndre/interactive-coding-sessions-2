...
# between square brackets one at time, separated by commas.
...
my_favorite_numbers[0:5:1] # Grabs all the element between index 0 and index 5
# (exclusive), don't skip any. 
my_favorite_numbers[1:4:1] # Grab all the element between 1 and 4 (exclusive),
# don't skip any.
