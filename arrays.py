...
# P and Q for 5 difference products
...
# Let's a few other examples showing how much nicer it is to work with arrays:
...
# With arrays, you can two more things:
...
arr_words[desired_indices] # I index using a list of indices I want.
